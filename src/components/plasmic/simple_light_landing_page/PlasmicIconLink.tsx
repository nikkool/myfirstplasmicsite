...
import * as sty from "./PlasmicIconLink.module.css" // plasmic-import: yRGZnZOGu0hId/css
    ...
    >
      ...
      >
        <p.PlasmicSlot
          defaultContents={
            <svg
              className={classNames(defaultcss.all, sty.svg__ax3Fd)}
              role={"img"}
            />
          }
          value={args.icon}
