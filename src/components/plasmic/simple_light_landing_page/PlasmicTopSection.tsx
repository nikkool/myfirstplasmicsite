...
import * as sty from "./PlasmicTopSection.module.css" // plasmic-import: x21pqtZY6006z/css

import heroImageK0IBjGvAbIl540 from "./images/heroImage.png" // plasmic-import: k0iBjGvABIl540/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___35AJo)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__jOamN)}
        >
          <div className={classNames(defaultcss.all, sty.box__iWrz)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__vXQy)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__ePvnf)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__fjMoV)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__ujdc2)}>
          <img
