...
import * as sty from "./PlasmicFeatureCard.module.css" // plasmic-import: r3340iALDPrai/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__nvU7X, {
            [sty.box__long__nvU7XggthD]: hasVariant(variants, "long", "long"),
          })}
        >
          <div
            className={classNames(defaultcss.all, sty.box___08Tqt, {
              [sty.box__long___08TqtggthD]: hasVariant(
                variants,
                "long",
                "long"
              ),
          ...
          >
            <p.PlasmicSlot
              defaultContents={
                <svg
                  className={classNames(defaultcss.all, sty.svg__h1BdS)}
                  role={"img"}
                />
              }
      ...
      <div
        className={classNames(defaultcss.all, sty.box__uNrW3, {
          [sty.box__long__uNrW3GgthD]: hasVariant(variants, "long", "long"),
        })}
      >
        <p.PlasmicSlot
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__vMPh, {
            [sty.box__long__vMPhGgthD]: hasVariant(variants, "long", "long"),
          })}
        >
          <p.PlasmicSlot
            defaultContents={
              <svg
                className={classNames(defaultcss.all, sty.svg__iqyqa)}
                role={"img"}
              />
            }
            value={args.iconBack}
