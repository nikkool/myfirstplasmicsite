...
import * as sty from "./PlasmicHomeCta.module.css" // plasmic-import: u811q6vKhqc5P/css

import SphereIcon from "./icons/PlasmicIcon__Sphere" // plasmic-import: eR7NFogVjA2NtV/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__abBeg)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__kDxy7)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box__rMDr3)}>
          <SphereIcon
