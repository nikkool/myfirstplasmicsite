...
import * as sty from "./PlasmicAvatar.module.css" // plasmic-import: Qjd769IB-Mpo39/css
    ...
    >
      <p.PlasmicSlot
        defaultContents={
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__qi5OZ)}
            role={"img"}
